...
export const LANDING_MOCK_DATA = {
  ...
  site: {
    ...
    socialLinks: {
      ...
      twitter: 'https://x.com/abdurrahman',
    },
    copyright: 'Learn with Abdur Rahman',
  ...
  contact: {
    ...
    contactInfo: [
      { icon: 'Mail', label: 'Email Us', value: 'hello@learnwithabdurrahman.com', note: 'Our friendly team is here to help.' },
  ...
  membership: {
    ...
    subtitle: 'Unlock your potential with a membership that fits your career goals. Cancel anytime.',
    tiers: [
      {
        title: 'Basic Member',
        requiredTier: 'Pro',
        description: ['Access to free preview courses', 'Community forum access', 'Weekly newsletter'],
      ...
      },
      {
        title: 'Pro Member',
        requiredTier: 'Pro',
        description: ['Unlimited access to all courses', 'Project files included', 'Certificate of completion', 'Priority community access'],
      ...
      },
      {
        title: 'Elite Member',
        requiredTier: 'Pro',
        description: ['Everything in Pro', '1-on-1 mentorship sessions', 'Resume & portfolio reviews', 'Direct Slack access to instructors'],
        buttonText: 'Start Elite Membership',
        buttonVariant: 'primary',

  ...
  return (
    <MarketingLayout>
      <Box sx={{ pt: { xs: 14, sm: 20 }, pb: { xs: 8, sm: 12 }, textAlign: 'center' }}>
        <Reveal delay={0.1}>
          <Typography variant="h1" sx={{ fontWeight: 900, mb: 3, fontSize: 'clamp(3rem, 6vw, 4.5rem)', lineHeight: 1.1 }}>
            Engineering <Box component="span" sx={{ color: 'primary.main' }}>Insights</Box>
          </Typography>
          <Typography variant="body1" color="text.secondary" sx={{ maxWidth: 680, mx: 'auto', fontSize: '1.15rem', lineHeight: 1.7 }}>
